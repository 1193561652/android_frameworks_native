    ...
    if (needs.drawShadows()) {
        ...
        if (needs.hasAlpha()) {
            ...
            if (needs.isPremultiplied()) {
                ...
                fs << "if(outTexCoords.x < extIndex || outTexCoords.x > extIndex+0.1 || extIndex==0.0 || extIndex=1.0) gl_FragColor *= color.a;";
            } else {
                fs << "if(outTexCoords.x < extIndex || outTexCoords.x > extIndex+0.1 || extIndex==0.0 || extIndex=1.0) gl_FragColor.a *= color.a;";
            }
        }
    }
