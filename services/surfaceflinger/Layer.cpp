...
void Layer::preparePerFrameCompositionState() {
    ...
    // ALOGE("BAT %p getIndex:%f",  this, (float)getIndex());
}
...
void Layer::prepareCompositionState(compositionengine::LayerFE::StateSubset subset) {
    ...
    // ALOGE("BAT %p subset:%d", this, subset);
    switch (subset) {
...
bool Layer::setAlpha(float alpha) {
    ...
    mCurrentState.modified = true;
    setTransactionFlags(eTransactionNeeded);
    ALOGE("BAT %p setAlpha:%f", this, alpha);
    return true;
}
bool Layer::setIndex(float index)
{
    if (mCurrentState.index == index) return false;
    mCurrentState.sequence++;
    mCurrentState.index = index;
    mCurrentState.modified = true;
    setTransactionFlags(eTransactionNeeded);
