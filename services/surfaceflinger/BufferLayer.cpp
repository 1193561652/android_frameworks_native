...
bool BufferLayer::isVisible() const {
    bool ret = !isHiddenByPolicy() && getAlpha() > 0.0f && (mBufferInfo.mBuffer != nullptr || mSidebandStream != nullptr);
    // ALOGE("BAT %p ret:%d %d %d %d %d", this, ret, isHiddenByPolicy(), getAlpha() > 0.0f, mBufferInfo.mBuffer != nullptr,  mSidebandStream != nullptr);
    return ret;
}
